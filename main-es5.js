(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhonemeCategoriesComponent = /** @class */ (function () {
                ...
                PhonemeCategoriesComponent.prototype.playAudio = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListComponent = /** @class */ (function () {
                ...
                ListComponent.prototype.playAudio = function () {
                    this.instruction.pause();
            ...
            var AComponent = /** @class */ (function () {
                ...
                AComponent.prototype.ngOnInit = function () {
                    ...
                    this.phonemeAudio.onended = function () {
                        _this.phonemeAnimate = false;
                        _this.apeAnimate = true;
                        Object(q__WEBPACK_IMPORTED_MODULE_2__["delay"])(250).then(function () {
                            _this.apeAudio.play();
                        });
                    };
                    this.apeAudio.onended = function () {
                        _this.apeAnimate = false;
                        _this.skateAnimate = true;
                        Object(q__WEBPACK_IMPORTED_MODULE_2__["delay"])(250).then(function () {
                            _this.skateAudio.play();
                        });
                    };
                    this.skateAudio.onended = function () {
                        _this.skateAnimate = false;
                        _this.craneAnimate = true;
                        Object(q__WEBPACK_IMPORTED_MODULE_2__["delay"])(250).then(function () {
                            _this.craneAudio.play();
                        });
                    };
                    this.craneAudio.onended = function () {
                        _this.craneAnimate = false;
                    };
                    this.playAudio();
                };
                AComponent.prototype.ngOnDestroy = function () {
                    this.phonemeAudio.pause();
                    this.apeAudio.pause();
                    this.skateAudio.pause();
                    this.craneAudio.pause();
                };
                AComponent.prototype.playAudio = function () {
                    this.phonemeAudio.pause();
                ...
                AComponent.prototype.playAudioA = function () {
                    var _this = this;
                    this.phonemeAnimate = true;
                    this.phonemeAudio.onended = function () {
                        _this.phonemeAnimate = false;
                        _this.phonemeAudio.onended = function () {
                            _this.phonemeAnimate = false;
                            _this.apeAnimate = true;
                            Object(q__WEBPACK_IMPORTED_MODULE_2__["delay"])(250).then(function () {
                                _this.apeAudio.play();
                ...
                AComponent.prototype.playApeAudio = function () {
                    var _this = this;
                    this.apeAnimate = true;
                    this.apeAudio.onended = function () {
                        _this.apeAnimate = false;
                        _this.apeAudio.onended = function () {
                            _this.apeAnimate = false;
                            _this.skateAnimate = true;
                            Object(q__WEBPACK_IMPORTED_MODULE_2__["delay"])(250).then(function () {
                                _this.skateAudio.play();
                ...
                AComponent.prototype.playSkateAudio = function () {
                    var _this = this;
                    this.skateAnimate = true;
                    this.skateAudio.onended = function () {
                        _this.skateAnimate = false;
                        _this.skateAudio.onended = function () {
                            _this.skateAnimate = false;
                            _this.craneAnimate = true;
                            Object(q__WEBPACK_IMPORTED_MODULE_2__["delay"])(250).then(function () {
                                _this.craneAudio.play();
                ...
                AComponent.prototype.playCraneAudio = function () {
                    var _this = this;
